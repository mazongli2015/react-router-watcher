...
var ReactRouterWatcher = /*#__PURE__*/function (_Component) {
  _inherits(ReactRouterWatcher, _Component);

  var _super = _createSuper(ReactRouterWatcher);

  function ReactRouterWatcher() {
    var _this;

    _classCallCheck(this, ReactRouterWatcher);
  ...
  _createClass(ReactRouterWatcher, [{
